...
sys.path.append(r'C:\Users\kamle\OneDrive\Desktop\careerbridge\Django\DjangoProjectDir\careerbridge_project')

# Setup Django Environment
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'careerbridge_project.settings')
django.setup()
